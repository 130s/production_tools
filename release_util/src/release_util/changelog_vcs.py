...
class Changelog_Vcs():
    ...
    def main(self, args=None, stdout=None, stderr=None):
        ...
        # If repo-downmost is present locally in the current directory, move on.
    ...
    def _is_downmost_repo_present(self, name_downmost_repo=None):
        """
    ...
    def get_a_changelog(self, repo_path):
        """
        @summary This is temporary. Code is basically copied from caking_pkg.cli.tag_changelog.main. This should be ported in upstream to avoid maintenance.
                 Generate a list of changelog for a repo given by a path.
